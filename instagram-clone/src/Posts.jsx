        ...
        return (
          <article className="post-card" key={post.id}>
            <div className="post-header">
              <img className="post-avatar" src={user.profilePicUrl} alt={user.username} />
              <strong>{user.username}</strong>
              <i className="bi bi-three-dots ms-auto" />
            </div>
            <img className="post-image" src={post.mediaUrls[0]} alt={post.caption} />
            <div className="post-actions">
              <i className="bi bi-heart" /><i className="bi bi-chat" /><i className="bi bi-send" />
